...
export type Lesson = Node & {
  ...
  /**
   * The github gist id from url. example:
   * https://gist.github.com/jvictorjs/c42691716cd9cb6164e1bed7ba2571bd
   * gist id = c42691716cd9cb6164e1bed7ba2571bd
   */
  githubGistId?: Maybe<Scalars['String']>;
...
export type LessonCreateInput = {
  ...
  githubGistId?: InputMaybe<Scalars['String']>;
  lessonType: LessonType;
  slug: Scalars['String'];
...
export type LessonManyWhereInput = {
  ...
  githubGistId?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  githubGistId_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  githubGistId_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  githubGistId_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  githubGistId_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  githubGistId_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  githubGistId_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  githubGistId_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  githubGistId_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  githubGistId_starts_with?: InputMaybe<Scalars['String']>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
...
export enum LessonOrderByInput {
  ...
  GithubGistIdAsc = 'githubGistId_ASC',
  GithubGistIdDesc = 'githubGistId_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
...
export type TeacherManyWhereInput = {
  ...
  githubUsername?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  githubUsername_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  githubUsername_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  githubUsername_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  githubUsername_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  githubUsername_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  githubUsername_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  githubUsername_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  githubUsername_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  githubUsername_starts_with?: InputMaybe<Scalars['String']>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
...
export enum TeacherOrderByInput {
  ...
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  GithubUsernameAsc = 'githubUsername_ASC',
  GithubUsernameDesc = 'githubUsername_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, lessonType: LessonType, githubGistId?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string, githubUsername?: string | null } | null } | null };
